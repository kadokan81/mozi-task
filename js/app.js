(() => {
    ...
    function initSliders() {
        if (document.querySelector(".users-trust__swiper")) {
            console.log("users-trust__swiper");
            new core(".users-trust__swiper", {
        ...
        new core(".innovations__slider", {
            modules: [ Pagination, Navigation ],
            slidesPerView: 1,
            spaceBetween: 30,
            navigation: {
                nextEl: ".innovations__slide-button-prev",
                prevEl: ".innovations__slide-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
